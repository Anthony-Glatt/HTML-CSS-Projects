...
namespace TwentyOne
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Welcome to {0}. Let us start by telling me your name.", casinoName);
            ...
            if (answer == "yes" || answer == "yeah" || answer == "y" || answer == "ya")
            {
                ...
                using (StreamWriter file = new StreamWriter(@"C:\Users\Anthony\Desktop\Programming\Blackjack Text Log\log.txt", true))
                {
        ...
        // ADO.NET connecting to a sql db to log exceptions
